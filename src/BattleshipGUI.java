...
public class BattleshipGUI {
    ...
    public void initBoards() {
        TitledBorder border1 = new TitledBorder("AI Bot");
        border1.setTitleJustification(TitledBorder.CENTER);
        border1.setTitlePosition(TitledBorder.TOP);
        TitledBorder border2 = new TitledBorder("AI Bot");
    ...
    public void initProbBoards() {
        TitledBorder border1 = new TitledBorder("Pirate Hit Probability");
        border1.setTitleJustification(TitledBorder.CENTER);
        border1.setTitlePosition(TitledBorder.TOP);
        TitledBorder border2 = new TitledBorder("Picnic Hit Probability");
        border2.setTitleJustification(TitledBorder.CENTER);
        border2.setTitlePosition(TitledBorder.TOP);
    ...
    public void initInfoPanel() {
        ...
        this.player1Label = new JButton("Pirate");
        ...
        this.player2Label = new JButton("Picnic HQ");
